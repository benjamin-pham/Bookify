...
public class ReservedBookingTests
{
    ...
    private readonly IUserRepositiory _userRepositoryMock;
    ...
    public ReservedBookingTests()
    {
        _userRepositoryMock = Substitute.For<IUserRepositiory>();
